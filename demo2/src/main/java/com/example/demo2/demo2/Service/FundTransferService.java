...
public class FundTransferService {
	...
	public FundTransferValues putTransfer(FundTransferValues fundTransferValues) {
		int amount=fundTransferValues.getAmount();
		int tranfer=fundTransferValues.getSentAmount();
		int reciveAmt=amount-tranfer;
		fundTransferValues.setAmount(reciveAmt);
		fundTransferValues.setrRecAccBal(amount+tranfer);
